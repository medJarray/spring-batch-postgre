...
public class OrderWriter extends AbstractWriter<OrderEntity> {
    ...
    protected String getSql() {
        return "INSERT INTO temp_order(order_id, order_date, client_full_name, amount, verified, phone_number, email, address)";
    }
    ...
    public void setValues(OrderEntity item, PreparedStatement ps) throws SQLException {
        ...
        ps.setString(7, OrderEntity.Address.flatAddress());
    }
}
